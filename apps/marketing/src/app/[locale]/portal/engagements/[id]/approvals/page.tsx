    ...
    <div>
      ...
      <div className="space-y-4">
        {workflows.map((w) => {
          ...
          return (
            <div key={w.ID} className="border border-white/10 rounded-lg p-5">
                    ...
                    {actionId === w.ID ? (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="bg-white/5 border border-white/10 rounded px-3 py-1.5 text-sm focus:outline-none focus:border-signal w-48"
                          autoFocus
                        />
                        <button
                          onClick={() => handleAction(w.ID, "approved")}
                          className="text-xs bg-signal text-white px-3 py-1.5 rounded font-medium hover:opacity-90"
                        >
                          Approve
                        </button>
                        <button
