        ...
        <div className="border border-white/10 rounded-lg p-4 mb-6 bg-white/[0.03]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-md px-3 py-2 text-sm focus:outline-none focus:border-signal"
          ...
          <div className="flex justify-end gap-2 mt-3">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-sm bg-signal text-black rounded-md hover:bg-signal/90 disabled:opacity-50"
            >
