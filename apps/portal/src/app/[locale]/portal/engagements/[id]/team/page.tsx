  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-display text-xl font-semibold tracking-tight">Team Directory</h2>
        <button
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="portal-panel-x mb-6 space-y-4 p-5">
...
function MemberCard({ member, onRemove, removing }: { member: TeamMember; onRemove: (id: string) => void; removing: boolean }) {
  ...
  return (
    <div className="portal-card-x group flex items-start gap-3 p-4">
