    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-display text-xl font-semibold tracking-tight">Support Tickets</h2>
        </div>
        ...
        <div className="portal-panel-x mb-6 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="md:col-span-3">
              ...
              <input value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} className="portal-field-x w-full" placeholder="Ticket title" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="number" value={form.sla_target_hours} onChange={(e) => setForm({ ...form, sla_target_hours: Number(e.target.value) })} className="portal-field-x w-full" />
            </div>
            <div className="md:col-span-3">
              <label className="text-xs text-white/50 mb-1 block">Description</label>
              <textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} className="portal-field-x w-full" rows={3} placeholder="Describe the issue or request..." />
            </div>
          </div>
      ...
      <div className="space-y-3">
        {tickets.map((t) => {
          ...
          return (
            <div key={t.ID} className="portal-card-x group p-4 transition-colors hover:border-signal/50">
