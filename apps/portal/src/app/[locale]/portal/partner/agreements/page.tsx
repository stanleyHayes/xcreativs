...
export default function PartnerAgreementsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="flex items-center gap-2 font-display text-3xl font-semibold tracking-tight"><FileText className="w-5 h-5 text-yellow-400" /> Partnership Agreements</h1>
      <div className="space-y-4">
        {agreements.map((a) => (
          <div key={a.ID} className="portal-card-x p-5">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="font-display text-xl font-semibold tracking-tight">{a.Title}</h3>
